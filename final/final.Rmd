...
data %>%
  select("Death, by injury, male %","Death, by injury, female %", "Population, female", "Population, male", "GDP per capita ($)", "School enrollment, M %", "School enrollment, F %", "Unemployment, male %", "Unemployment, female %") %>% 
...
# Create separate bar plots for male and female indicators
...
# Create the scatter plot with plain labels
